...
static void expand(struct mem_zone *zone, struct page *page,unsigned long low_order, unsigned long high_order,struct free_area *area){
...
static struct page *__alloc_page(unsigned long order,struct mem_zone *zone){
    struct page *page;
    struct free_area *area;
